    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: '#e2e6f0' }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 32px', height: '56px', borderBottom: '1px solid var(--border)', background: 'var(--nav-bg)', backdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ ...S.mono, fontSize: 9, color: 'var(--muted)' }}>Foreign Exchange Services</div>
          </div>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <a href="/login" style={{ padding: '5px 16px', borderRadius: 6, border: '1px solid var(--border)', background: 'transparent', color: 'var(--muted)', ...S.mono, fontSize: 10, textDecoration: 'none', letterSpacing: '0.05em' }}>STAFF LOGIN</a>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px 64px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <p style={{ ...S.mono, fontSize: 13, color: 'var(--muted)', margin: '0 auto', maxWidth: 420, lineHeight: 1.8 }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
            {BRANCHES.map(b => (
              <div key={b.name} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16, padding: '24px 28px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                    <span style={{ ...S.mono, fontSize: 10, color: 'var(--muted)', marginTop: 1, flexShrink: 0 }}>ADDRESS</span>
                    <span style={{ ...S.mono, fontSize: 11, color: '#e2e6f0', lineHeight: 1.6 }}>{b.address}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                    <span style={{ ...S.mono, fontSize: 10, color: 'var(--muted)', marginTop: 1, flexShrink: 0 }}>HOURS</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 20 }}>
            {[
              ...
              <div key={s.title}>
                ...
                <div style={{ ...S.mono, fontSize: 11, color: 'var(--muted)', lineHeight: 1.7 }}>{s.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ── FOOTER NOTE ── */}
        <div style={{ ...S.mono, fontSize: 10, color: 'var(--muted)', textAlign: 'center', lineHeight: 2, letterSpacing: '0.06em' }}>
