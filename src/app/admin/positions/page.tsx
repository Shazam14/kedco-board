    ...
    <div style={{ minHeight:'100vh', background:'#080a10', color:'#e2e6f0' }}>
      ...
      <nav style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 32px', height:'56px', borderBottom:'1px solid #1e2230', background:'rgba(15,17,23,0.96)', backdropFilter:'blur(12px)', position:'sticky', top:0, zIndex:100 }}>
        ...
        <div style={{ display:'flex', gap:8 }}>
          <a href="/dashboard" style={{ padding:'6px 16px', borderRadius:6, border:'1px solid #1e2230', background:'transparent', color:'#4a5468', fontFamily:"'DM Mono',monospace", fontSize:11, textDecoration:'none' }}>← Dashboard</a>
      ...
      <div style={{ padding:'28px 32px', display:'flex', flexDirection:'column', gap:20 }}>
        {/* Header */}
        <div>
          <div style={{ fontFamily:"'DM Mono',monospace", fontSize:10, color:'#4a5468', letterSpacing:'0.2em', marginBottom:6 }}>ADMIN · POSITIONS</div>
        ...
        {/* Info card */}
        <div style={{ background:'#0f1117', border:'1px solid rgba(91,140,255,0.25)', borderRadius:14, padding:'20px 24px' }}>
