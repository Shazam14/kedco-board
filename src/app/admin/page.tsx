        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(280px, 1fr))', gap:16 }}>
          {tools.map(tool => (
            ...
            >
              ...
              <div style={{ fontFamily:"'Syne',sans-serif", fontSize:15, fontWeight:700, color: tool.soon ? 'var(--muted)' : '#e2e6f0', marginBottom:6 }}>
                {tool.title}
                {tool.soon && <span style={{ fontFamily:"'DM Mono',monospace", fontSize:9, color:'var(--muted)', marginLeft:8, letterSpacing:'0.1em' }}>COMING SOON</span>}
              </div>
