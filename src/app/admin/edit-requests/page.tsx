...
import EditRequestsShell from '@/app/_components/EditRequestsShell';
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "'DM Mono',monospace", fontSize: 9, color: 'var(--muted)', marginTop: -2 }}>Edit Requests</div>
          </div>
        </div>
        <a href="/admin" style={{
